...
//import com.helper.util.CommonConstants;
//import com.helper.util.CommonUtil;
...
//    public static String keyImagePath = CommonConstants.DEFAULT_KEY_IMAGE_PATH;
//    public static String keyPdfPath = CommonConstants.DEFAULT_KEY_PDF_PATH;
//
...
//                if (!CommonUtil.isEmptyOrNull(object.optString(objectKey))) {
...
//                    } else {
//                        callback.onFailure(new Exception(CommonConstants.NO_DATA));
//                    }
//                } else {
//                    callback.onFailure(new Exception(CommonConstants.NO_DATA));
//                }
//            } else {
//                callback.onFailure(new Exception(CommonConstants.EMPTY_OR_NULL_DATA));
//            }
